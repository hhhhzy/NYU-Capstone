...
if __name__ == "__main__":
    ...
    best_config = {'epochs':4, 'pe_type': '3d_temporal', 'batch_size': 1, 'feature_size': 36, 'num_enc_layers': 2\
                , 'num_dec_layers': 2, 'temporal_insert_layer' : 2, 'num_head': 2, 'd_ff': 512, 'dropout': 0.2, 'lr': 1e-4, 'lr_decay': 0.9, 'loss_type':'l1', 'delta': 0.2\
    ...
    train_loader, test_loader, scaler, data = get_data_loaders(train_proportion, test_proportion, val_proportion,\
        ...
        noise_std = noise_std, scaler_type = scaler_type, seed = simulation_seed, res_size='32')
